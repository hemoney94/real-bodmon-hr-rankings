...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Mirror the parameters used by established Baseball Savant clients.
    // `all=true`, a season filter and group_by=name are important; without them
    // Savant can return an empty result even though games exist in the date window.
